...
| stop.arrived / departed | `workers/api/src/do/sequencer.ts:711@stop.arrived` | n/a — goes through DO |
| device-namespaced event | `workers/api/src/do/sequencer.ts:1250@deviceOwnedBy` (sig verify) | `deviceOwnedBy` before slot claim |
