...
//   · HONEST HOLD (the pattern at workers/agents/src/biller.ts:647@resolveRecipient ): a recipient with no billing email HOLDS with NOTHING
...
// SAME per-entry predicate the Biller's resolveRecipient (`workers/agents/src/biller.ts:260@resolveRecipient`
