...
//
// SELF-CLEARING + IDEMPOTENT (the deterministic-id UPSERT mirrors the anchor alarms —
// anchor.ts:309-374@recordAnchorFailure — which differ in that they do NOT re-open a resolved row): the alarm is written by the
